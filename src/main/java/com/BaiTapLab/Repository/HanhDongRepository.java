...
public interface HanhDongRepository extends JpaRepository<HanhDong, Integer> {
	...
	@Query("SELECT new com.BaiTapLab.DTO.PopupDTO(hd.ten_hanh_dong, hd.popup) FROM HanhDong hd ")
	...
	@Query("SELECT new com.BaiTapLab.DTO.SanPhamDTO(hd.ten_hanh_dong, hd.sanpham) FROM HanhDong hd ")
