...
public interface SearchRepository extends JpaRepository<SanPham, String> {
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "FROM SanPham s WHERE s.danhmuc.danh_mucId = ?1 "
			+ "AND (?2 = true AND s.phantram_GG > 0 OR ?2 = false AND s.phantram_GG >= 0 )"
			+ "AND s.hoat_dong LIKE 'Working' AND s.trang_thai_xoa = '' ")
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "(SELECT h.ten_hinh FROM HinhAnh h WHERE h.sanpham.san_phamId = s.san_phamId ORDER BY h.id ASC LIMIT 1) AS tenHinhDauTien "
			+ "FROM SanPham s WHERE s.danhmuc.danh_mucId = ?1 "
			+ "AND ((?2 = 5 AND (SELECT AVG(dg.so_sao) FROM DanhGia dg WHERE dg.sanpham.san_phamId = s.san_phamId) = 5) "
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	List<Object[]> findSanPhamByDanhMucNameSoSaoMore100k(String danhmuc, String name, int sosao, 
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	List<Object[]> findSanPhamByDanhMucNameSoSaoLess10k(String danhmuc, String name, int sosao, 
			boolean showDiscount);
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "(SELECT COUNT(dg) FROM DanhGia dg WHERE dg.sanpham.san_phamId = s.san_phamId) AS soDanhGia, "
			+ "(SELECT h.ten_hinh FROM HinhAnh h WHERE h.sanpham.san_phamId = s.san_phamId ORDER BY h.id ASC LIMIT 1) AS tenHinhDauTien "
			+ "FROM SanPham s WHERE  s.ten_san_pham LIKE %?1%"
			+ "AND (?2 = true AND s.phantram_GG > 0 OR ?2 = false AND s.phantram_GG >= 0 )"
			+ "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "(SELECT COUNT(dg) FROM DanhGia dg WHERE dg.sanpham.san_phamId = s.san_phamId) AS soDanhGia, "
			+ "(SELECT h.ten_hinh FROM HinhAnh h WHERE h.sanpham.san_phamId = s.san_phamId ORDER BY h.id ASC LIMIT 1) AS tenHinhDauTien "
			+ "FROM SanPham s  " + "WHERE s.gia_goc BETWEEN ?1 AND ?2"
			+ "AND ((?3 = true AND s.phantram_GG > 0) OR (?3 = false AND s.phantram_GG >= 0)) "
			+ "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "AND s.ten_san_pham LIKE %?3%"
			+ "AND ((?4 = true AND s.phantram_GG > 0) OR (?4 = false AND s.phantram_GG >= 0)) "
			+ "AND s.gia_goc >= 100000 " + "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "AND s.ten_san_pham LIKE %?3%"
			+ "AND ((?4 = true AND s.phantram_GG > 0) OR (?4 = false AND s.phantram_GG >= 0)) "
			+ "AND s.gia_goc <= 10000 " + "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "AND s.ten_san_pham LIKE %?3%"
			+ "AND ((?4 = true AND s.phantram_GG > 0) OR (?4 = false AND s.phantram_GG >= 0)) "
			+ "AND s.gia_goc BETWEEN ?5 AND ?6 " + "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "FROM SanPham s  WHERE s.danhmuc.danh_mucId = ?1" + "AND s.ten_san_pham LIKE %?2%"
			+ "AND ((?3 = true AND s.phantram_GG > 0) OR (?3 = false AND s.phantram_GG >= 0)) "
			+ "AND s.gia_goc BETWEEN ?4 AND ?5 " + "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "FROM SanPham s  WHERE " + " s.ten_san_pham LIKE %?1%"
			+ "AND ((?2 = true AND s.phantram_GG > 0) OR (?2 = false AND s.phantram_GG >= 0)) "
			+ "AND s.gia_goc BETWEEN ?3 AND ?4 " + "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "(SELECT h.ten_hinh FROM HinhAnh h WHERE h.sanpham.san_phamId = s.san_phamId ORDER BY h.id ASC LIMIT 1) AS tenHinhDauTien "
			+ "FROM SanPham s  WHERE "
			+ " ((?1 = true AND s.phantram_GG > 0) OR (?1 = false AND s.phantram_GG >= 0)) "
			+ "AND s.gia_goc BETWEEN ?2 AND ?3 " + "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "AND ((?4 = true AND s.phantram_GG > 0) OR (?4 = false AND s.phantram_GG >= 0)) "
			+ "AND s.gia_goc BETWEEN ?5 AND ?6 " + "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	List<Object[]> findSanPhamByDiscountSosaoNameDanhMucDefaultOrNot(String danhmuc,String name,int sosao, boolean showDiscount, long default1,
			long default2);
	// dm name
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			+ "s.so_luong, s.han_gg, s.trang_thai_kho, s.luot_mua, s.hoat_dong, s.phe_duyet, s.trang_thai_xoa, "
			...
			+ "AND ((?3 = true AND s.phantram_GG > 0) OR (?3 = false AND s.phantram_GG >= 0)) "
			+ "AND s.gia_goc BETWEEN ?4 AND ?5 " + "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	List<Object[]> findSanPhamByDiscountNameDanhMucDefaultOrNot(String danhmuc,String name, boolean showDiscount, long default1,
			long default2);
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "AND ((?3 = true AND s.phantram_GG > 0) OR (?3 = false AND s.phantram_GG >= 0)) "
			+ "AND s.gia_goc BETWEEN ?4 AND ?5 " + "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	List<Object[]> findSanPhamByDiscountSosaoDanhMucDefaultOrNot(String danhmuc,int sosao, boolean showDiscount, long default1,
			long default2);
	...
	@Query("SELECT s.san_phamId, s.ten_san_pham, s.ngay_tao, s.gia_goc, s.gia_km, s.mo_ta, s.phantram_GG, "
			...
			+ "(SELECT h.ten_hinh FROM HinhAnh h WHERE h.sanpham.san_phamId = s.san_phamId ORDER BY h.id ASC LIMIT 1) AS tenHinhDauTien "
			+ "FROM SanPham s  WHERE "
			+ " s.ten_san_pham LIKE %?1%"
			+ "AND (( ?2 = 5 AND (SELECT AVG(dg.so_sao) FROM DanhGia dg WHERE dg.sanpham.san_phamId = s.san_phamId) = 5) "
			+ "OR (?2 < 5 AND (SELECT AVG(dg.so_sao) FROM DanhGia dg WHERE dg.sanpham.san_phamId = s.san_phamId) BETWEEN ?2 AND (?2 + 0.9))) "
			+ "AND ((?3 = true AND s.phantram_GG > 0) OR (?3 = false AND s.phantram_GG >= 0)) "
			+ "AND s.gia_goc BETWEEN ?4 AND ?5 " + "AND s.hoat_dong = 'Working' AND s.trang_thai_xoa = ''")
	List<Object[]> findSanPhamByDiscountSosaoNameDefaultOrNot(String name,int sosao, boolean showDiscount, long default1,
			long default2);
