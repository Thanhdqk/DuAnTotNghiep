...
public class RescontrollerSanPham {
	...
	public List<Map<String, Object>> FindSanPhamByDanhMucIDWithOutGG(@RequestParam("id") String id) {
	...
	public List<Map<String, Object>> FindFullListProductThisWEEK() {
		...
		List<Object[]> results = SanPhamService.FindProductThisWeek();
	...
	// find full sản phẩm  Discount
		...
		public List<Map<String, Object>> FindFullListProductDiscount() {
			...
			List<Object[]> results = SanPhamService.FindProductDiscount();
		...
		public List<Map<String, Object>> findSanPhamLast7DaysTOP100() {
			 ...
			 List<Map<String, Object>> sanPhamList = new ArrayList<>();
			    ...
			    for (Object[] row : results) {
			        Map<String, Object> sanPham = new HashMap<>();
			        sanPham.put("sanPhamId", row[0]);
			        sanPham.put("tenSanPham", row[1]);
			        sanPham.put("ngayTao", row[2]);
			        sanPham.put("giaGoc", row[3]);
			        sanPham.put("giaKm", row[4]);
			        sanPham.put("moTa", row[5]);
			        sanPham.put("phanTramGG", row[6]);
			        sanPham.put("soLuong", row[7]);
			        sanPham.put("hanGG", row[8]);
			        sanPham.put("trangThaiKho", row[9]);
			        sanPham.put("luotMua", row[10]);
			        sanPham.put("hoatDong", row[11]);
	...
	// tìm kiếm sản phẩm theo tuần mới nhất new
	...
	public List<Object[]> FindProductTopSell() {
...
//                          start  tìm theo 5 SAO
	    ...
	    public List<SanPham> findSanPhamBySoSaoEqual5AndDanhMucAndNameHaveDiscount(@RequestParam String danhmuc, @RequestParam String name) {
	    ...
	    public List<SanPham> findSanPhamBySoSaoEqual5DefaultHaveDiscount(@RequestParam long default1, @RequestParam long default2) {
	    ...
	    public List<SanPham> findSanPhamBySoSaoAndNameEqual5Less10kHaveDiscount(@RequestParam long price, @RequestParam String name) {
	    ...
	    public List<SanPham> findSanPhamBySoSaoAndNameEqual5More100kHaveDiscount(@RequestParam long price, @RequestParam String name) {
	    ...
	    public List<SanPham> findSanPhamBySoSaoAndNameAndDanhmucEqual5Less10kHaveDiscount(
	    ...
	    public List<SanPham> findSanPhamBySoSaoAndNameAndDanhmucEqual5More100kHaveDiscount(
	            @RequestParam long price, 
	            @RequestParam String name, 
	            @RequestParam String danhmuc) {
	    ...
	    public List<SanPham> findSanPhamBySoSaoEqual5DefaulAndNameHaveDiscount(
	            @RequestParam long default1, 
	    ...
	    public List<SanPham> findSanPhamBySoSaoEqual5DefaulAndDanhmucHaveDiscount(
	            @RequestParam long default1, 
	            @RequestParam long default2, 
	            @RequestParam String danhmuc) {
	    ...
	    public List<SanPham> findSanPhamBySoSaoEqual5DefaulAndDanhmucAndNameHaveDiscount(
	            @RequestParam long default1, 
	            @RequestParam long default2, 
	            @RequestParam String danhmuc, 
	            @RequestParam String name) {
	        return SanPhamService.findSanPhamBySoSaoEqual5DefaulAndDanhmucAndNameHaveDiscount(default1, default2, danhmuc, name);
	    }
	    
	 // API lấy sản phẩm có 5 sao, giá <= giá chỉ định, trong danh mục chỉ định và có giảm giá
	 ...
	 // 15. Tìm sản phẩm chỉ có số sao = 5 (không cần giảm giá)
	    ...
	    public List<SanPham> findSanPhamBySoSaoEqual5AndDanhMucAndName(@RequestParam String danhmuc, @RequestParam String name) {
	    ...
	    public List<SanPham> findSanPhamBySoSaoAndNameAndDanhmucEqual5Less10k(
	            @RequestParam long price, 
	            @RequestParam String name, 
	            @RequestParam String danhmuc) {
	    ...
	    public List<SanPham> findSanPhamBySoSaoAndNameAndDanhmucEqual5More100k(
	            @RequestParam long price, 
	            @RequestParam String name, 
	            @RequestParam String danhmuc) {
	    ...
	    public List<SanPham> findSanPhamBySoSaoEqual5DefaultAndName(
	            @RequestParam long default1, 
	            @RequestParam long default2, 
	            @RequestParam String name) {
	    ...
	    public List<SanPham> findSanPhamBySoSaoEqual5DefaultAndDanhmuc(
	            @RequestParam long default1, 
	            @RequestParam long default2, 
	            @RequestParam String danhmuc) {
	    ...
	    public List<SanPham> findSanPhamBySoSaoEqual5DefaultAndDanhmucAndName(
	            @RequestParam long default1, 
	            @RequestParam long default2, 
	            @RequestParam String danhmuc, 
	            @RequestParam String name) {
...
//                           start tìm theo thương hiệu
	 ...
	 // Tìm sản phẩm giá lớn hơn 100k
	    ...
	    public List<SanPham> findSanPhamByPriceMore100kAndDanhMucAndText(@RequestParam Long price, @RequestParam String category, @RequestParam String text) {
	    ...
	    public List<SanPham> findSanPhamByPriceMore100kAndDanhMucAndDiscount(@RequestParam Long price, @RequestParam String category) {
	        // API này tìm sản phẩm có giá lớn hơn và thuộc một danh mục, đồng thời có giảm giá
	    ...
	    public List<SanPham> findSanPhamByPriceMore100kAndDanhMucAndSosao(@RequestParam Long price, @RequestParam String category, @RequestParam int rating) {
	    ...
	    public List<SanPham> findSanPhamByPriceMore100kAndTextAndDiscount(@RequestParam Long price, @RequestParam String text) {
	        // API này tìm sản phẩm có giá lớn hơn và có tên sản phẩm khớp với text, đồng thời có giảm giá
	    ...
	    public List<SanPham> findSanPhamByPriceMore100kAndTextAndSosao(@RequestParam Long price, @RequestParam String text, @RequestParam int rating) {
	    ...
	    public List<SanPham> findSanPhamByPriceMore100kAndDiscountAndSosao(@RequestParam Long price, @RequestParam int rating) {
	    ...
	    public List<SanPham> findSanPhamByPriceMore100kAndDanhMucAndTextAndDiscount(@RequestParam Long price, @RequestParam String category, @RequestParam String text) {
	        // API này tìm sản phẩm có giá lớn hơn, thuộc danh mục và tên sản phẩm, đồng thời có giảm giá
	    ...
	    public List<SanPham> findSanPhamByPriceMore100kAndDanhMucAndTextAndSosao(@RequestParam Long price, @RequestParam String category, @RequestParam String text, @RequestParam int rating) {
	    ...
	    public List<SanPham> findSanPhamByPriceMore100kAndDanhMucAndDiscountAndSosao(@RequestParam Long price, @RequestParam String category, @RequestParam int rating) {
	        // API này tìm sản phẩm có giá lớn hơn, thuộc danh mục và có giảm giá, đồng thời có sao đánh giá khớp
	    ...
	    public List<SanPham> findSanPhamByPriceMore100kAndTextAndDiscountAndSosao(@RequestParam Long price, @RequestParam String text, @RequestParam int rating) {
	        // API này tìm sản phẩm có giá lớn hơn, có tên sản phẩm và có giảm giá, đồng thời sao đánh giá khớp
	    ...
	    public List<SanPham> findSanPhamByAllConditionsWithPriceMore100k(@RequestParam Long price, @RequestParam String category, @RequestParam String text, @RequestParam int rating) {
