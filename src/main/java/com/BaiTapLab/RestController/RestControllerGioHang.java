...
public class RestControllerGioHang {
	...
	public GioHang addGioHang(@PathVariable("userId") String userId, @PathVariable("sanphamId") String sanphamId,
	...
	public GioHang adddGioHang2(@PathVariable("userId") String userId, @PathVariable("sanphamId") String sanphamId,
			@PathVariable("soluong") int soluong) {
