...
public class SearchRestController {
	...
	public List<Map<String, Object>> findSanPhamByDiscountWithNameOrNot(@RequestParam("name") String name,@RequestParam("showDiscount") Boolean showDiscount) {
	...
	public List<Map<String, Object>> findSanPhamByDiscountWithDanhMucOrNot(@RequestParam("id") String id,@RequestParam("showDiscount") Boolean showDiscount) {
	...
	public List<Map<String, Object>> findSanPhamByDiscountWithSosaoOrNot(@RequestParam("rating") int rating,@RequestParam("showDiscount") Boolean showDiscount) {
	...
	public List<Map<String, Object>> findSanPhamByDiscountMore100kOrNot(@RequestParam("showDiscount") Boolean showDiscount) {
	...
	public List<Map<String, Object>> findSanPhamByDiscountLess10kOrNot(@RequestParam("showDiscount") Boolean showDiscount) {
	...
	public List<Map<String, Object>> findSanPhamByDiscountDefaultOrNot(@RequestParam("showDiscount") Boolean showDiscount,@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucSoSaoOrNot(@RequestParam("id") String id,@RequestParam("rating") int rating,@RequestParam("showDiscount") Boolean showDiscount) {
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucNameOrNot(@RequestParam("id") String id,@RequestParam("name") String name,@RequestParam("showDiscount") Boolean showDiscount) {
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucSoSaoNameOrNot(@RequestParam("id") String id,@RequestParam("name") String name,@RequestParam("rating") int rating,@RequestParam("showDiscount") Boolean showDiscount) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountDanhMucSoSaoNameOrNot(id,rating,name,showDiscount);
	...
	public List<Map<String, Object>> findSanPhamByDiscountSoSaoNameOrNot(@RequestParam("name") String name,@RequestParam("rating") int rating,@RequestParam("showDiscount") Boolean showDiscount) {
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucSoSaoNameMore100KOrNot(@RequestParam("id") String id,@RequestParam("name") String name,@RequestParam("rating") int rating,@RequestParam("showDiscount") Boolean showDiscount) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountDanhMucSoSaoNameMore100KOrNot(id,rating,name,showDiscount);
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucNameMore100KOrNot(@RequestParam("id") String id,@RequestParam("name") String name,@RequestParam("showDiscount") Boolean showDiscount) {
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucSoSaoMore100kOrNot(@RequestParam("id") String id,@RequestParam("rating") int rating,@RequestParam("showDiscount") Boolean showDiscount) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountDanhMucSoSaoMore100kOrNot(id,rating,showDiscount);
	...
	public List<Map<String, Object>> findSanPhamByDiscountSoSaoNameMore100kOrNot(@RequestParam("name") String name,@RequestParam("rating") int rating,@RequestParam("showDiscount") Boolean showDiscount) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountSoSaoNameMore100kOrNot(name,rating,showDiscount);
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucSoSaoNameLess10KOrNot(@RequestParam("id") String id,@RequestParam("name") String name,@RequestParam("rating") int rating,@RequestParam("showDiscount") Boolean showDiscount) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountDanhMucSoSaoNameLess10KOrNot(id,rating,name,showDiscount);
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucNameLess10KOrNot(@RequestParam("id") String id,@RequestParam("name") String name,@RequestParam("showDiscount") Boolean showDiscount) {
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucSoSaoLess10kOrNot(@RequestParam("id") String id,@RequestParam("rating") int rating,@RequestParam("showDiscount") Boolean showDiscount) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountDanhMucSoSaoLess10kOrNot(id,rating,showDiscount);
	...
	public List<Map<String, Object>> findSanPhamByDiscountSoSaoNameLess10kOrNot(@RequestParam("name") String name,@RequestParam("rating") int rating,@RequestParam("showDiscount") Boolean showDiscount) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountSoSaoNameLess10kOrNot(name,rating,showDiscount);
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucSoSaoNamedefaultOrNot(@RequestParam("id") String id,@RequestParam("name") String name,
			@RequestParam("showDiscount") Boolean showDiscount, @RequestParam("rating") int rating,
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountDanhMucSoSaoNamedefaultOrNot(id,rating,name,showDiscount,Default1,Default2);
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucNamedefaultOrNot(@RequestParam("id") String id,@RequestParam("name") String name,
			@RequestParam("showDiscount") Boolean showDiscount, 
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountDanhMucNamedefaultOrNot(id,name,showDiscount,Default1,Default2);
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucSoSaodefaultOrNot(@RequestParam("id") String id,
			@RequestParam("showDiscount") Boolean showDiscount, @RequestParam("rating") int rating,
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountDanhMucSoSaodefaultOrNot(id,rating,showDiscount,Default1,Default2);
	...
	public List<Map<String, Object>> findSanPhamByDiscountSoSaoNamedefaultOrNot(@RequestParam("name") String name,
			@RequestParam("showDiscount") Boolean showDiscount, @RequestParam("rating") int rating,
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountSoSaoNamedefaultOrNot(rating,name,showDiscount,Default1,Default2);
	...
	public List<Map<String, Object>> findSanPhamByDiscountNamedefaultOrNot(@RequestParam("name") String name,
			@RequestParam("showDiscount") Boolean showDiscount, 
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountNamedefaultOrNot(name,showDiscount,Default1,Default2);
	...
	public List<Map<String, Object>> findSanPhamByDiscountSoSaodefaultOrNot(@RequestParam("rating") int rating,
			@RequestParam("showDiscount") Boolean showDiscount, 
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountSoSaodefaultOrNot(rating,showDiscount,Default1,Default2);
	...
	public List<Map<String, Object>> findSanPhamByDiscountDanhMucdefaultOrNot(@RequestParam("id") String id,
			@RequestParam("showDiscount") Boolean showDiscount, 
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountDanhMucdefaultOrNot(id,showDiscount,Default1,Default2);
	...
	public List<Map<String, Object>> FindSanphamByPriceMore100k(
			@RequestParam("showDiscount") Boolean showDiscount 
			) {
	...
	public List<Map<String, Object>> FindSanphamByPriceNameDanhMucSosaoMore100k(@RequestParam("id") String id,@RequestParam("name") String name,@RequestParam("rating") int rating,
			@RequestParam("showDiscount") Boolean showDiscount 
			) {
		List<Object[]> results = SearchRepository.FindSanphamByPriceNameDanhMucSosaoMore100k(id,name,rating,showDiscount);
	...
	public List<Map<String, Object>> FindSanphamByPriceNameMore100k(@RequestParam("id") String id,@RequestParam("name") String name,
			@RequestParam("showDiscount") Boolean showDiscount 
			) {
	...
	public List<Map<String, Object>> FindSanphamByPriceNameSosaoMore100k(@RequestParam("name") String name,@RequestParam("rating") int rating,
			@RequestParam("showDiscount") Boolean showDiscount 
			) {
	...
	public List<Map<String, Object>> FindSanphamByPriceDanhMucSosaoMore100k(@RequestParam("id") String id,@RequestParam("rating") int rating,
			@RequestParam("showDiscount") Boolean showDiscount 
			) {
	...
	public List<Map<String, Object>> FindSanphamByPriceLess10k(
			@RequestParam("showDiscount") Boolean showDiscount 
			) {
	...
	public List<Map<String, Object>> FindSanphamByPriceNameDanhMucSosaoLess10k(@RequestParam("id") String id,@RequestParam("name") String name,@RequestParam("rating") int rating,
			@RequestParam("showDiscount") Boolean showDiscount 
			) {
		List<Object[]> results = SearchRepository.FindSanphamByPriceNameDanhMucSosaoLess10k(id,name,rating,showDiscount);
	...
	@GetMapping("Search/FindSanphamByPriceNameLESS10k")
	public List<Map<String, Object>> FindSanphamByPriceNameLESS10k(@RequestParam("id") String id,@RequestParam("name") String name,
			@RequestParam("showDiscount") Boolean showDiscount 
			) {
	...
	public List<Map<String, Object>> FindSanphamByPriceNameSosaoLESS10k(@RequestParam("name") String name,@RequestParam("rating") int rating,
			@RequestParam("showDiscount") Boolean showDiscount 
			) {
	...
	public List<Map<String, Object>> FindSanphamByPriceDanhMucSosaoLESS10k(@RequestParam("id") String id,@RequestParam("rating") int rating,
			@RequestParam("showDiscount") Boolean showDiscount 
			) {
	...
	@GetMapping("Search/findSanPhamByDiscountNameDefaultOrNot")
	public List<Map<String, Object>> findSanPhamByDiscountNameDefaultOrNot(
	...
	@GetMapping("Search/findSanPhamByDiscountDanhmucDefaultOrNot")
	public List<Map<String, Object>> findSanPhamByDiscountDanhmucDefaultOrNot(
	...
	@GetMapping("Search/findSanPhamByDiscountSosaoDefaultOrNot")
	public List<Map<String, Object>> findSanPhamByDiscountSosaoDefaultOrNot(
			@RequestParam("rating") int rating, 
			@RequestParam("showDiscount") Boolean showDiscount, 
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountSosaoDefaultOrNot(rating,showDiscount,Default1,Default2);
	...
	public List<Map<String, Object>> findSanPhamByDiscountSosaoNameDanhMucDefaultOrNot(
			@RequestParam("id") String id,
			@RequestParam("name") String name,
			@RequestParam("rating") int rating, 
			@RequestParam("showDiscount") Boolean showDiscount, 
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountSosaoNameDanhMucDefaultOrNot(id,name,rating,showDiscount,Default1,Default2);
	...
	public List<Map<String, Object>> findSanPhamByDiscountNameDanhMucDefaultOrNot(
			@RequestParam("id") String id,
			@RequestParam("name") String name,
			
			@RequestParam("showDiscount") Boolean showDiscount, 
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountNameDanhMucDefaultOrNot(id,name,showDiscount,Default1,Default2);
	...
	public List<Map<String, Object>> findSanPhamByDiscountSosaoDanhMucDefaultOrNot(
			@RequestParam("id") String id,
			
			@RequestParam("rating") int rating, 
			@RequestParam("showDiscount") Boolean showDiscount, 
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountSosaoDanhMucDefaultOrNot(id,rating,showDiscount,Default1,Default2);
	...
	public List<Map<String, Object>> findSanPhamByDiscountSosaoNameDefaultOrNot(
			...
			@RequestParam("showDiscount") Boolean showDiscount, 
			@RequestParam("Default1") Long Default1, @RequestParam("Default2") Long Default2) {
		List<Object[]> results = SearchRepository.findSanPhamByDiscountSosaoNameDefaultOrNot(name,rating,showDiscount,Default1,Default2);
