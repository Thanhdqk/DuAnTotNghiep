...
@Service
public class MailerServiceImpl implements MailerServiceKhanh {
...
//					new File("C:\\Users\\DELL\\Documents\\totnghiep\\DuAnTotNghiep\\src\\main\\resources"));
			FileTemplateLoader templateLoader = new FileTemplateLoader(
	...
	@Override
	public String bodyTemplate2(Map<String, Object> model) {
		String html = "";
		try {
			MimeMessage message = sender.createMimeMessage();
			// Sử dụng Helper để thiết lập các thông tin cần thiết cho message
