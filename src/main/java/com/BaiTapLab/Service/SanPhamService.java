...
public class SanPhamService {
	...
	public List<SanPham> findSanPhamByPriceDefaultAndDanhMucAndText(Long Default1 ,Long Default2,String danhmuc, String text )
	{
	...
	public List<SanPham> findSanPhamByPriceDefaultAndDanhMucAndSosao(Long Default1 ,Long Default2,String danhmuc, int sosao )
	{
	...
	public List<SanPham> findSanPhamByPriceDefaultAndTextAndSosao(Long Default1 ,Long Default2,String text,int sosao )
	{
	...
	public List<SanPham> findSanPhamByPriceDefaultAndDanhMucAndTextAndDiscount(Long Default1 ,Long Default2, String danhmuc, String text )
	{
		return SanphamRepository.findSanPhamByPriceDefaultAndDanhMucAndTextAndDiscount(Default1, Default2,danhmuc,text);
	}
	
	public List<SanPham> findSanPhamByPriceDefaultAndDanhMucAndTextAndSosao(Long Default1 ,Long Default2, String danhmuc, String text,int sosao )
	{
		return SanphamRepository.findSanPhamByPriceDefaultAndDanhMucAndTextAndSosao(Default1, Default2,danhmuc,text,sosao);
	}
	
	public List<SanPham> findSanPhamByPriceDefaultAndDanhMucAndDiscountAndSosao(Long Default1 ,Long Default2, String danhmuc,int sosao )
	{
		return SanphamRepository.findSanPhamByPriceDefaultAndDanhMucAndDiscountAndSosao(Default1, Default2,danhmuc,sosao);
	}
	
	public List<SanPham> findSanPhamByPriceDefaultAndTextAndDiscountAndSosao(Long Default1 ,Long Default2, String text,int sosao )
	{
		return SanphamRepository.findSanPhamByPriceDefaultAndTextAndDiscountAndSosao(Default1, Default2,text,sosao);
	}
	
	public List<SanPham> findSanPhamByAllConditionsWithPriceDefault(Long Default1 ,Long Default2,String danhmuc, String text, int sosao )
	{
	...
	public List<SanPham> findSanPhamByPriceLessHaveDanhMucAndTextAndSosao(Long price, String danhmuc, String text, int sosao)
	{
	...
	public List<SanPham> findSanPhamByPriceMoreAndDanhMucAndTextAndSosao(Long price, String danhmuc, String text, int sosao)
	{
